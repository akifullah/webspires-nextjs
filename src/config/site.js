export const siteConfig = {
    name: 'Webspires',
    url: process.env.NEXT_PUBLIC_DEV === 'true' ? process.env.NEXT_PUBLIC_LOCAL_URL ? process.env.NEXT_PUBLIC_LOCAL_URL : 'http://localhost:3000' : process.env.NEXT_PUBLIC_BASE_URL,
    description:
