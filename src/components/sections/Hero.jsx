        ...
        <section className="bg-[#faf9f7] overflow-hidden">
            ...
            <div className="max-w-[1320px] mx-auto px-6 lg:px-10 pt-16 pb-0 lg:pt-20 flex flex-col lg:flex-row items-center gap-10 lg:gap-0">
                ...
                <div className="flex-1 max-w-[600px] lg:pr-10 z-10">
                    {/* Eyebrow */}
                    <p className="text-[#3a3a3a] font-bold uppercase tracking-widest text-sm lg:text-base mb-3">
                    ...
                    <div className="flex flex-col sm:flex-row items-center gap-4 mb-8">
                        <a
                            href="#contact"
                            id="hero-cta-primary"
                            className="inline-flex items-center gap-2 bg-primary hover:bg-primary/90 text-white font-bold text-sm tracking-wide px-7 py-3.5 rounded-lg transition-all duration-200 shadow-[0_4px_14px_rgba(238,49,79,0.4)] hover:shadow-[0_6px_20px_rgba(238,49,79,0.5)] hover:-translate-y-0.5 whitespace-nowrap"
                        >
